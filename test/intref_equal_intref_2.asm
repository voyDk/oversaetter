...
# was:	ori	_exp__20_, 0, 0
	sll	$2, $2, 2
# was:	sll	_offset__21_, _exp__20_, 2
	add	$2, $2, $16
# was:	add	_add__22_, _offset__21_, a_1_
	lw	$2, 0($2)
# was:	lw	_equal1__17_, 0(_add__22_)
	ori	$3, $0, 1
# was:	ori	_exp__24_, 0, 1
	sll	$3, $3, 2
# was:	sll	_offset__25_, _exp__24_, 2
	add	$3, $3, $16
# was:	add	_add__26_, _offset__25_, a_1_
	lw	$3, 0($3)
# was:	lw	_equal2__18_, 0(_add__26_)
	ori	$4, $0, 0
